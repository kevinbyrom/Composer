...
namespace Composer
{
    ...
    public class Voice 
    {
        ...
        public Voice(Func<SampleTime, Sample> signalFunc, Func<SampleTime, Sample> ampFunc, Func<SampleTime, Sample, Sample> effectFunc, double duration, ISampleTarget target)
        {
        ...
        public void WriteNext(SampleTime time)
        {
